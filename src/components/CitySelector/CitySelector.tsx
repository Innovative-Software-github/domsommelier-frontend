...
// Дропдаун выбора города временно отключён — просто показываем «Пермь».
// Чтобы вернуть выбор города, раскомментируйте импорты и логику ниже
// и верните <Select ... /> вместо статичного текста.
